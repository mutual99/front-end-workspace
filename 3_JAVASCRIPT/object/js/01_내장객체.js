...
function btn4() {
  ...
  console.log("월 : ", now.getMonth() + 1); // 0 ~ 11
  console.log("일 : ", now.getDate()); // 14
  console.log("시 : ", now.getHours()); // 11
  console.log("분 : ", now.getMinutes()); // 43 ...
  console.log("초 : ", now.getSeconds()); // 55 ...
}

function btn5() {
  const a = new Date(2025, 0, 5, 11, 50, 20); // 2025년 1월 5일 11시 50분 20초
  console.log(a);
  ...
  const c = new Date(2024, 4, 26); // 2024-05-16
  console.log(c);
}
